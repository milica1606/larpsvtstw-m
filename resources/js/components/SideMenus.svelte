...
<div class="grid grid-cols-[auto_1fr] h-full">
    <AppRail selected={storeValue} class="text-token">
        <Authguard>
            <svelte:fragment slot="authed">
                <AppRailTile class="h-20" label={$t("Admin")} title={$t("Admin")} tag="a" href="/role/Admin" value={1}>
                ...
                <AppRailTile class="h-20" label={$t("Editor")} title={$t("Editor")} tag="a" href="/role/Editor" value={2}>
                ...
                <AppRailTile class="h-20" label={$t("Reviewer")} title={$t("Reviewer")} tag="a" href="/role/Reviewer" value={3}>
                ...
                <AppRailTile class="h-20" label={$t('Author')} title={$t('Author')} tag="a" href="/role/Author" value={4}>
                ...
                <AppRailTile class="h-20" label={$t('Organizer')} title={$t('Organizer')} tag="a" href="/role/Organizer" value={5}>
                ...
                <AppRailTile class="h-20" label={$t('Typewriter')} title={$t('Typewriter')} tag="a" href="/role/Typewriter" value={6}>
    ...
    <section class="role_menus">
        {#if $storeValue == 1}
            <div id="Admin" class="menu_title">Admin</div>
            <nav class="list-nav">
                <ul>
                    <li class="navitem">
                        <a href="/#/role/Admin" use:active>
                            <span class="flex-auto">{$t("Admin")} {$t("Home")}</span>
                        </a>
                    </li>
                </ul>
            </nav>
        {/if}
        {#if $storeValue == 2}
            <div id="Editor" class="menu_title">{$t("Editor")}</div>
            <nav class="list-nav">
                <ul>
                    <li class="navitem">
                        <a href="/#/role/Editor" use:active>
                            <span class="flex-auto">{$t("Editor")} {$t("Home")}</span>
                        </a>
                    </li>
                </ul>
            </nav>
        {/if}
        {#if $storeValue == 3}
            <div id="Reviewer" class="menu_title">{$t("Reviewer")}</div>
            <nav class="list-nav">
                <ul>
                    <li class="navitem">
                        <a href="/#/role/Reviewer" use:active>
                            <span class="flex-auto">{$t("Reviewer")} {$t("Home")}</span>
                        </a>
                    </li>
                </ul>
            </nav>
        {/if}
        {#if $storeValue == 4}
            <div id="Author" class="menu_title">{$t("Author")}</div>
            <nav class="list-nav">
                <ul>
                    <li class="navitem">
                        <a href="/#/role/Author" use:active>
                            <span class="flex-auto">{$t("Author")} - {$t("Home")}</span>
                        </a>
                    </li>
                    <li class="navitem">
                        <a href="/#/role/Author/another" use:active>
                            <span class="flex-auto">{$t("Author")} - {$t("Another menu item")}</span>
                        </a>
                    </li>
                </ul>
            </nav>
        {/if}
        {#if $storeValue == 5}
            <div id="Organizer" class="menu_title">{$t("Organizer")}</div>
            <nav class="list-nav">
                <ul>
                    <li class="navitem">
                        <a href="/#/role/Organizer" use:active>
                            <span class="flex-auto">{$t("Organizer")} {$t("Home")}</span>
                        </a>
                    </li>
                </ul>
            </nav>
        {/if}
        {#if $storeValue == 6}
            <div id="Typewriter" class="menu_title">{$t("Typewriter")}</div>
            <nav class="list-nav">
                <ul>
                    <li class="navitem">
                        <a href="/#/role/Typewriter" use:active>
                            <span class="flex-auto">{$t("Typewriter")} {$t("Home")}</span>
                        </a>
                    </li>
                </ul>
            </nav>
...
<style>
    .navitem {
        @apply block max-w-[100%];/* rounded-token font-token text-token hover:bg-primary-hover-token; 'token' means 'from theme' */
    }
    .navitem a {
        @apply inline-block w-[100%] btn variant-ghost-primary btn-base /* px-4 py-2*/;
    }
    .menu_title {
        @apply text-primary-700 dark:text-primary-500 font-bold uppercase px-4;
    }
    .role_menus {
        @apply p-4 pb-20 space-y-4 overflow-y-auto;
    }
</style>
